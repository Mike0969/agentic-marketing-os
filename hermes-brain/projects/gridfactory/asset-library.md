# GridFactory — Asset Library (index + rules)
...
The actual assets live in the DB table `project_assets` (project_slug = `gridfactory`) and are managed in the app at **Marketing → Assets**. This file documents how agents should USE them.
