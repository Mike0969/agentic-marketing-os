          ...
          {runtimeAgents.map((agent) => {
            ...
            return (
              <Panel key={agent.id}>
                ...
                {agent.name === "Crina" ? (
                  <Link href="/marketing/workflows/weekly-content-plan" className="mt-4 inline-flex h-10 items-center justify-center rounded-md bg-slate-950 px-4 text-sm font-semibold text-white transition hover:bg-slate-800 dark:bg-slate-100 dark:text-slate-950 dark:hover:bg-white">
