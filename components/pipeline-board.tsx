        ...
        <aside className="lg:sticky lg:top-4 lg:self-start">
          {selectedItem ? (
            <article className="rounded-lg border border-slate-200 bg-white p-4 shadow-panel dark:border-slate-800 dark:bg-slate-950">
              ...
              {selectedItem.visual_asset_url ? (
                <div className="mt-4 overflow-hidden rounded-md border border-slate-200 bg-slate-50 dark:border-slate-800 dark:bg-slate-900">
