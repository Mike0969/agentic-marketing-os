...
export const brands: Brand[] = [
  {
    ...
    pillars: "AI power demand; grid constraints; data-center infrastructure; interconnection; bankability; power reliability.",
    ...
    ctas: "Request the infrastructure brief; Talk to us about AI power readiness; Review the investor-grade infrastructure thesis.",
  ...
  },
  {
    ...
    pillars: "GCC electric mobility; zero-commission ride-hailing; driver economics; AI dispatch; rider trust; tokenized loyalty.",
    ...
    ctas: "Join the NexRide early access list; Register interest as a driver or fleet partner; Explore the Gulf-EL mobility model.",
